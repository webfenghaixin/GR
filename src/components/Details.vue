<template>
    <div class="all-bg">
                ...
                <div class="choose" >
                    ...
                    <div id="ischoose">
                        <div class="choose-cont" v-for="(item,n) of color" :key="n" >
                            <button @click="choose" :data-color="item">{{item}}</button>
                        </div>
                    </div>
                </div>
                <div class="number">
                    ...
                    <div class="number-cont">
                        ...
                        <input type="text" v-model="num" id="numberinput"/>
        ...
        <div class="bottom">
         ...
         <div class="hint" id="showmsg">{{msg}}</div>
        </div>
    </div>
</template>
<script>
export default {
    ...
    methods:{
        addcart(){
            var url="addcart?cid="+this.list[0].id+"&count="+this.num+"&title="+this.list[0].title+"&img="+this.list[0].img_url+"&color="+this.colorc+"&price="+this.list[0].price;
                var hint=document.getElementById("showmsg");
        ...
        choose(e){
            // 保存选中的颜色到colorc中
            this.colorc=e.target.dataset.color;
