...
export default { 
    ...
    methods:{
        search(){
             var url=`searchdetail?msg=${this.$route.query.msg}`;
...
<style scoped>
    ...
    .left-cont>ul>li a:first-child{
        ...
        cursor: pointer;
        background: url('../img/off-icon.png') 8px -39px no-repeat;
    }
    .left-cont ul li{
        height: 39px;
        overflow: hidden;
