<template>
    <div id="d11">
        <table></table>
        <div class="banner-bg" style="background: url('../img/buy_banner.jpg') no-repeat;">
            <h3>夏季清仓</h3>
            <p>宝宝被子，衣服3折起</p>
        </div>
        <div class="cart">
...
export default {
    ...
    methods:{
        ...
        del(e){
            ...
            var url="delcart?cid="+this.list[i].cid;
