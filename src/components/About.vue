<template>
    <div>
        <div class="banner-box">
            <div class="banner" style="background: url('../img/us_banner.jpg') no-repeat;"></div>
        </div>
        <div class="cont">
            <div class="img-box">
                <img src="../img/us_img1.jpg" alt="">
                <img src="../img/us_img2.jpg" alt="">
            </div>
            <div class="text">
        ...
        <div class="banner-text" style="background: url('../img/us_img3.png') no-repeat;">
            <div class="w1200">
                <p>我们的母婴产业2016年涉足母婴行业，以品牌经销为主，在强大市场的推动下，于2016年创立自己的独立品牌。公司立足于江西南昌，2年的品牌沉淀和运营经验让我们在行业中获得良好的口碑和市场份额。以直营+连锁加盟模式，让成功可复制，成为越来越多中小投资者的优选项目，更多的妈妈青睐我们的产品。</p>
            </div>
        </div>
